...
# class XRPrioQuerySet(query.RateableQuerySet, query.CommentableQuerySet):
#     pass


# class XRPrio(module_models.Item):
...
#     objects = XRPrioQuerySet.as_manager()

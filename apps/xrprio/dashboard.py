...
#         if models.XRPrio.objects.filter(module=module).exists():
#             return 1, 1
#         return 0, 1
...
#                 views.XRPrioListDashboardView.as_view(component=self),
#                 "topic-list",
#             ),
#             (
#                 r"^topics/create/module/(?P<module_slug>[-\w_]+)/$",
#                 views.XRPrioCreateView.as_view(component=self),
#                 "topic-create",
#             ),
#             (
#                 r"^topics/(?P<year>\d{4})-(?P<pk>\d+)/update/$",
#                 views.XRPrioUpdateView.as_view(component=self),
#                 "topic-update",
#             ),
#             (
#                 r"^topics/(?P<year>\d{4})-(?P<pk>\d+)/delete/$",
#                 views.XRPrioDeleteView.as_view(component=self),
#                 "topic-delete",
#             ),
#         ]
...
#                 views.XRPrioDashboardExportView.as_view(),
#                 "topic-export-module",
#             ),
#             (
